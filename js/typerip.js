	...
	*/	
	...
	ajaxRequest.onload = function() {
		...
		for (i = 0; i < json.family.total_font_count; i++) {
            ...
            output.fonts.push({url: font_url, name: json.family.fonts[i].name , foundry_name: json.family.foundry.name, foundry_slug: json.family.foundry.slug});
        }		
...
function downloadFont(url_, fontName_) {
	/*
	...
	*/
	...
	ajaxRequest.onload = function() {
		...
		element.setAttribute('download', fontName_ + ".woff2");
